            	...
            	<div class="col-sm-6">
                	<div class="contact">
                        ...
                        <div class="contact_inn">
                         <input type="text" class="form-control-one" placeholder="Name">
                         <input type="text" class="form-control-one" placeholder="Email">
                         <input type="text" class="form-control-one" placeholder="Subject">
