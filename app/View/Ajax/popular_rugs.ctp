...
<div class="row" id="ttricon-c">

    <div class="col-sm-12">
        <div class="row">
            <?php echo $this->element("pager-common", array("title" => "recent rug designs", "visible" => true)); ?>
        </div>
        <div class="row">
            <?php if ($view != "list") {
...
<script type="text/javascript">
    $(document).ready(function() {
        try {
            ko.cleanNode($('#ttricon-c')[0]);
        } catch (e) {
        }
        ko.applyBindings({}, $('#ttricon-c')[0]);
    });
